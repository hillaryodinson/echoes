...
export const template = (subject: string, component: string) => {
	return `<!doctype html>
<html lang="en">
  <head>
...
export const messageWithCTAComponent = (
	message: string,
                      ...
                      <tr>
                        <td align="left">
                          <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tbody>
                              <tr>
                                <td> <a href="${action.href}" target="_blank">${action.text}</a> </td>
                              </tr>
                            </tbody>
                          </table>
                        </td>
...
export const messageComponent = (message: string) => {
	return `${message}`;
};
